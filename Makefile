...
LIBS += drivers/mtd/spi-nand/libspi_nandflash.a
...
ALL += $(obj)u-boot.dis $(obj)u-boot.srec $(obj)u-boot.img $(obj)System.map $(U_BOOT_NAND) $(U_BOOT_ONENAND)
ifeq ($(CONFIG_SPL), y)
...
$(obj)u-boot-spl.bin: $(SRCTREE)/spl/u-boot-spl
	$(OBJCOPY) ${OBJCFLAGS} -O binary $< $@
	
$(SRCTREE)/spl/u-boot-spl:
	$(Q)$(MAKE) obj=$(SRCTREE)/spl/ -f Makefile_spl.mk all
...
fh81_devboard_config	:	unconfig
	$(MKCONFIG) $(@:_config=) arm fh fh81_devboard Fullhan fh


fh62_devboard_config	: unconfig
	$(MKCONFIG) $(@:_config=) arm fh fh62_devboard Fullhan fh
